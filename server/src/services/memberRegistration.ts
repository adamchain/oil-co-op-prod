...
export const registerMemberSchema = z.object({
  ...
  // Join form fields (oilco-op.com/join)
  membershipPlan: z.enum(["standard", "senior", "lowVolume"]).optional().default("standard"),
  middleName: z.string().optional().default(""),
  sameMailingAddress: z.boolean().optional().default(true),
  mailingAddressLine1: z.string().optional().default(""),
  mailingCity: z.string().optional().default(""),
  mailingState: z.string().optional().default(""),
  mailingPostalCode: z.string().optional().default(""),
  primaryPhoneType: z.string().optional().default(""),
  secondaryPhone: z.string().optional().default(""),
  secondaryPhoneType: z.string().optional().default(""),
  interestedInOil: z.boolean().optional().default(false),
  currentOilProvider: z.string().optional().default(""),
  stayWithOilProvider: z.boolean().optional().default(false),
  interestedInPropane: z.boolean().optional().default(false),
  currentPropaneProvider: z.string().optional().default(""),
  stayWithPropaneProvider: z.boolean().optional().default(false),
  interestedInSolar: z.boolean().optional().default(false),
  interestedInEnergyAudit: z.boolean().optional().default(false),
  interestedInInsurance: z.boolean().optional().default(false),
  whoReferredYou: z.string().optional().default(""),
  affiliatedOrganization: z.boolean().optional().default(false),
...
export async function registerMember(
  ...
  const member = await Member.create({
    ...
    legacyProfile: {
      midName1: body.middleName || "",
      standardMembership: body.membershipPlan === "standard",
      seniorMember: body.membershipPlan === "senior",
      lowVolume: body.membershipPlan === "lowVolume",
      membershipPlan: body.membershipPlan,
      mailAddr: body.sameMailingAddress === false,
      ...(body.sameMailingAddress === false
        ? {
            mailCity: body.mailingCity || "",
            mailState: body.mailingState || "",
            mailZip: body.mailingPostalCode || "",
          }
        : {}),
      typePhone1: body.primaryPhoneType || "CELL",
      phone2: body.secondaryPhone || "",
      typePhone2: body.secondaryPhoneType || "",
      interestedInOil: body.interestedInOil,
      currentOilProvider: body.currentOilProvider || "",
      stayWithOilProvider: body.stayWithOilProvider,
      interestedInPropane: body.interestedInPropane,
      currentPropaneProvider: body.currentPropaneProvider || "",
      stayWithPropaneProvider: body.stayWithPropaneProvider,
      interestedInSolar: body.interestedInSolar,
      interestedInEnergyAudit: body.interestedInEnergyAudit,
      interestedInInsurance: body.interestedInInsurance,
      whoReferYou: body.whoReferredYou || "",
      referredByName: body.whoReferredYou || "",
      affiliatedOrganization: body.affiliatedOrganization,
      organization: body.organization || "",
      nextStep: body.organization || "",
    },
  });
